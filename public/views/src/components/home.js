...
var HomepageComponents = () => {
    ...
    var SubscriptSection = () => {
        return (
            <div className="lg-7 offset-left offset-right md-12 sm-12 flexbox content-center items-start column-direction p-all-15"> 
    ...
    var TutorialsSection = () => {
        return (
            <div className="row content-center section-block">
                <h2 className="custom-headline section-head text-center">Check our latest tutorials</h2>
        ...
        return (
            <>
                <section className="hero white-bg hero">
                    <div className="wrapper max-1172 offset-left offset-right">
                        <div className="row plr-15 mlr--30 ptb-50 section-subscribe">
                            <SubscriptSection/>
                        </div>
                        <div className="row plr-15 mlr--30 ptb-50 section-features">
                            <SiteFeaturesSection/>
                        </div>
